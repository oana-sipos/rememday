...
Entry.create(name: 'tassos.natsakis@kuleuven.be', date: '2015-02-10', memory: 'Azi e usor',    mood: 5, weight: 55, facebook_id: '534606643')
Entry.create(name: 'oanasipos@gmail.com',         date: '2015-02-10', memory: 'Azi e iubire',  mood: 2, weight: 45, facebook_id: '1370813229')
