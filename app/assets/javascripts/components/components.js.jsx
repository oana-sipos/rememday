...
var FaceBookOrGravatarPic = React.createClass({
  facebook_id: function(){
    return this.props.facebook_id
  },
  render: function() {
    if (this.props.facebook_id !== null) {
      return <FacebookPic user_id={this.facebook_id()} />
    } else {
...
var FacebookPic = React.createClass({
  render: function() {
    return (
      <img src={'https://graph.facebook.com/v2.5/' + this.props.user_id + '/picture'} />
    );
  }
});
...
var Gravatar = React.createClass({
  ...
  render: function() {
    var thingy = this.gravatar(this.props.email);
    return (
      <img src={thingy} />
    );
  }
